...
class PE2_tester3 {
	...
	// This tester checks if validateNote throws an exception. However, it does not check the  type of exception.
     ...
     public void testValidateNote1() {
		...
		//comment it out if it passes unless you wanna hear it every time
		@Test
      ...
      //set score
        ...
        @Test 
        void testNoteCompareTo105() {
            Note note1 = new Note(60, 100, 4); 
            Art note2 = new Note(60, 100, 0); 
            int ret = note1.compareTo(note2); 
            boolean actual = ret != 0;  
            assertEquals(true, actual, "Note's compareTo does not work as expected");
        }
        @Test
